...
const contractorService = {
    ...
    cityCategory: async (category, data) => {
        try {
            const response = await axiosInstance.post('/contractors/cityCategory/' + category, data)
            return response.data
        } catch (error) {
            throw error.response.data
        }
    ...
    contractorBySubcategory: async (id , data) => {
        try {
            const response = await axiosInstance.post(`/contractors/subcategory/${id}` , data)
            return response.data
        } catch (error) {
            throw error.response.data
        }
