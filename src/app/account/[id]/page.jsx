    ...
    <div className="flex flex-col items-center gap-5  h-full">
      <div className="p-5 flex flex-col gap-5 items-center">
        ...
        <div className="flex items-start gap-3 w-full relative">
          <div className="w-7 h-7 bg-[#12937C] rounded-full absolute top-3 left-3 transform translate-x-[-50%] translate-y-[-50%]" />
...
const Message = (props) => {
  return (
    <div className="flex flex-col gap-3 w-full font-semibold text-sm text-[#262626] opacity-80 h-auto px-4 py-6 rounded-2xl bg-[#12937C] bg-opacity-10">
