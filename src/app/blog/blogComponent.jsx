    ...
    <>
      ...
      {loading ? (
        ...
        <div className="mx-auto justify-center items-center mt-28">
          ...
          <div
            ref={featuredRef}
            className="lg:w-[1100px] w-screen m-auto py-10"
          >
            <h1 className="text-[28px] font-bold pb-7">Featured</h1>

            <div className="flex max-md:flex-col flex-wrap w-full md:w-[100%] gap-10">
              <div
                className="w-[50%] max-lg:w-[95%] max-md:m-auto cursor-pointer"
                onClick={() =>
                  navigate.push(
                    `/blog/${blogs?.featured?.[0].title
                      .replaceAll(" ", "-")
                      .toLowerCase()}`
                  )
                }
              ...
              <div className="flex flex-col flex-wrap gap-3 w-[45%] hidden lg:block">
                <div
                  className="flex bg-[#E8F5F2] gap-4 rounded-2xl  h-[220px] cursor-pointer "
                  onClick={() =>
                    navigate.push(
                      `/blog/${blogs?.featured?.[1].title
                        .replaceAll(" ", "-")
                        .toLowerCase()}`
                    )
                  }
                  ...
                  <div className="p-4 flex flex-col justify-between">
                    <div>
                      ...
                      <div className="flex justify-between mt-2">
                        ...
                        <h1 className="font-[400] text-[12px] text-gray-500">
                          {moment(blogs?.featured?.[1]?.created_date)?.format(
                            "MMM Do YY"
                          )}
                        </h1>
                      </div>
                    ...
                    <h1
                      ...
                      className="font-[400] text-[14px] text-[#12937C] cursor-pointer "
                    >
                      Read More
                    </h1>
                  </div>
                ...
                <div
                  className="flex bg-[#E8F5F2] gap-4 rounded-2xl  mt-4 h-[220px] cursor-pointer"
                  onClick={() =>
                    navigate.push(
                      `/blog/${blogs?.featured?.[2].title
                        .replaceAll(" ", "-")
                        .toLowerCase()}`
                    )
                  }
                  ...
                  <div className="p-4 flex flex-col justify-between">
                    <div>
                      ...
                      <div className="flex justify-between mt-2">
                        ...
                        <h1 className="font-[400] text-[12px] text-gray-500">
                          {moment(blogs?.featured?.[2]?.created_date)?.format(
                            "MMM Do YY"
                          )}
                        </h1>
                      </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10 max-md:w-[90%] max-md:m-auto">
              {blogs?.designs.map((value, index) => (
                <div key={index} className="max-md:mt-4 ">
                  ...
                  />
                  <h1 className="mt-2 text-[16px] font-[500]">
                    {value?.title.split(0, 50)}...
                  </h1>
                  ...
                  <button
                    ...
                    className="border border-[#12937C] text-[#12937C] font-[500] text-sm p-2 rounded-xl mt-4"
                  >
                    Read More
                  </button>
                </div>
                          ...
                          >
                            <div class="h-[280px]  items-start select-text">
                              <div class="flex p-3">
                                ...
                                <Link
                                  href="/create-project"
                                  class="absolute bottom-4 left-1/2 transform -translate-x-1/2 w-[70%] text-xs mt-3 cursor-pointer hover:bg-primary hover:text-white transition-none text-text mb-2 min-w-55 justify-center px-3 py-3 rounded-2xl font-bold bg-transparent border-primary border inline-flex items-center mx-auto"
                                >
                                  Get A Free Quote
                                </Link>
                              </div>
