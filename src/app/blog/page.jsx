...
const design = [
  {
    ...
    image: "/public/assets/Rectangle120.png",
  },
  {
...
const Page = () => {
  ...
  return (
    <div className="mx-auto justify-center items-center">
      ...
      <div className="flex mt-8 ml-[9%] lg:w-[1100px] w-screen mx-auto justify-center items-center">
      ...
      <div className="py-6 my-10 bg-[#F7F9FB] ">
        <div className="flex justify-between max-md:flex-col gap-10  m-auto align-center items-center lg:w-[1100px] w-screen">
          <div>
      ...
      <div className="py-6 my-10 bg-[#F7F9FB] ">
        <div className="flex max-md:flex-col-reverse max-md:flex-col gap-12 lg:w-[1100px] w-screen m-auto align-center items-center">
          <div className="bg-[#12937C] rounded-xl p-6 ">
