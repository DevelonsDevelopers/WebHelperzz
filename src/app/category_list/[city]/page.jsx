...
function CategoryList({ params }) {
  ...
  return (
    <>
      ...
      <div className="max-w-[1300px] mx-auto justify-center">
        <div className="md:mt-40 mt-28" style={{ alignItems: "center" }}>
          <h1 className="text-center text-4xl font-semibold">
            {`Service Providers in ${params.city}`}
          </h1>
          <h3 className="text-gray-500 mt-10 mx-7 mb-3 text-left">
        ...
        <ul className="list_container">
          <li className="flex-col">
            <h1 className="font-bold text-xl">Main Category</h1>
            <div className="py-[6px] text-lg">
              <Link
                href="/"
