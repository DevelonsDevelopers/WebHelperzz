        ...
        <div className="">
            ...
            <div className="bg-[#1B3047] mt-[5rem] py-20">
                <div className="max-w-[1000px] m-auto">
                    ...
                    <h1 className="text-[1rem] font-[600] text-gray-300 max-w-[500px] mt-4">Our team is ready to assist
                        you. Reach out to one of our teams below. </h1>
            ...
            <div className="flex max-md:flex-col max-w-[800px] my-10 max-md:w-[90%] m-auto ">
                <div className="flex-col ">
                    {tabs.map((value, index) => (
                        <h1 key={index} onClick={() => setSelected(index)}
                            className={`border-t-[1px] border-b-[1px] border-l-[1px] border-gray-400 min-w-[250px] py-4 pl-4 text-lg text-gray-600 mt-2 cursor-pointer rounded-l-md ${selected === index ? 'bg-[#EDEEEF]' : 'bg-white hover:bg-[#EDEEEF]'}`}
                        >
                            {value.name}
                        </h1>
                    ))}
                ...
                {selected === 0 ?
                    ...
                    <div className="w-1/.2 !border-[1px] border-gray-400 px-10 max-md:px-4 py-8 mt-2">
                        ...
                        <h1 className="text-gray-700 text-[14px] my-4 text-center font-[500]">Fill out the form below to
                        ...
                        <h1 className="text-gray-700 text-[14px] my-4 text-center font-[400]">*Our team is available
                            Monday - Friday from 9 am to 5 pm EST </h1>
                    </div>
                    :
                    <div className="w-1/.2 !border-[1px] border-gray-400 px-10 py-8 mt-2">
                        ...
                        <h1 className="text-gray-700 text-[14px] my-4 text-center font-[400] italic	">*Our team is
                            available Monday - Friday from 9 am to 5 pm EST </h1>
                        <h1 className="text-gray-700 text-[14px] text-center font-[400] italic	">For inquiries
                            regarding removal of personal data, please see our privacy policy</h1>
