...
const Page = () => {
    ...
    const handleSubmit = (e) => {
        ...
        console.log(serviceProData)
        console.log(selected)
        let data = {first_name: "", last_name: "", company: "", phone: "", email: "", topic: "", message: "", type: ""}
        if (selected === 1) {
            data.first_name = homeOwnerData.name
            data.last_name = homeOwnerData.last_name
            data.email = homeOwnerData.email
            data.message = homeOwnerData.message
            data.type = "HOME OWNER"
        } else {
            data.first_name = serviceProData.name
            data.last_name = serviceProData.last_name
            data.email = serviceProData.email
            data.message = serviceProData.message
            data.phone = serviceProData.phone
            data.topic = serviceProData.topic
            data.company = serviceProData.company_name
