        ...
        if (option) {
                ...
                {step === 3 && (
                    <>
                        ...
                        <Textarea message={"This Step is Optional"} handleDetails={handleDetails}/>
                        <div className="grid grid-cols-2 gap-10 mt-5 ">
                            <button
                                className="bg-white rounded-2xl text-lg font-semibold py-3"
                                onClick={() => setStep(step - 1)}
...
const Textarea = ({message, value, handleDetails}) => {
    return (
        <div className="relative w-full">
            <div
                className="absolute -top-5 left-5 text-sm lg:text-base px-5 lg:px-10 text-white py-2 bg-secondary rounded-xl">
                {message}
            </div>
