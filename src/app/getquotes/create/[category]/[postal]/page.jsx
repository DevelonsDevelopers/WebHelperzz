    ...
    return (
        ...
        />
            ...
            <header>
                ...
                <div
                    className="header h-[15vh] shadow-lg background-color-gray color-gray flex items-center justify-center relative shadow-gray-200">
            ...
            {submitting ? (
                ...
                <section className="bg-gray-50">
                    <div
                        className="flex w-[screen] md:w-[700px] flex-col items-center justify-center px-6 mx-auto h-[screen] lg:py-0 md:pt-28px pt-10">
                        ...
                        <div className="grid  grid-cols-1 align-items-start grid-rows-auto md:pt-10 pt-5">
                            ...
                            <div
                                className="md:w-[700px] w-[screen] bg-white  rounded-lg shadow dark:border md:mt-0 md:mx-auto xl:p-0">
                    ...
                    {nextBox.showNextBox && (
                        ...
                        >
                            <div className="grid grid-cols-1 align-items-start grid-rows-auto ">
                                ...
                                <div
                                    className="w-[screen]  md:w-[700px] bg-white rounded-lg shadow dark:border  md:mt-0 xl:p-0">
                                    <div className="p-4 w-[screen] space-y-4 md:space-y-6 md:p-8 text-black">
                                        <div className=" items-center justify-center flex flex-wrap ">
                                            ...
                                            >
                                                ...
                                                {" "}
                                                <label
                                                    className={`mx-auto items-center flex justify-center text-lg md:text-xl  font-normal ${
                                                        selectedType === "Detached / Semi-Detached Home"
                                                            ? "text-blue-400"
                                                            : "text-gray-500 "
                                                    }`}>
                    ...
                    {nextBox.showThirdBox && (
                        ...
                        >
                            <div className="grid grid-cols-1 align-items-start grid-rows-auto">
                                ...
                                <div
                                    className="md:w-[700px] w-[screen] bg-white rounded-lg shadow dark:border md:mt-0 xl:p-0">
                    ...
                    {nextBox.showFourthBox && (
                        ...
                        >
                            <div className="grid grid-cols-1 align-items-start grid-rows-auto">
                                ...
                                <div
                                    className="w-[screen] sm:w-[600px] md:w-[700px]  bg-white rounded-lg shadow dark:border md:mt-0 xl:p-0">
                  <textarea
                      onChange={(e) =>
                          setRequestData((data) => ({
                              ...data,
                        ...
                        >
                            <div className="grid grid-cols-1 align-items-start grid-rows-auto">
                                ...
                                <div
                                    className="md:w-[700px] w-[screen] bg-white rounded-lg shadow dark:border md:mt-0 xl:p-0">
                                    <div
                                        className="p-4 md:w-[700px] w-[screen] space-y-4 md:space-y-6 md:p-8 text-black">
