          ...
          <div className="flex flex-col gap-3 lg:items-center w-fit p-1">
            <form className='flex flex-col gap-5 md:mx-6 p-5 md:p-12 w-[100vw] lg:w-[1000px] bg-white shadow-lg' onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className='flex flex-col'>
                ...
                <input type='text' className='border-2 w-full p-2' {...register("businessname")} placeholder='Your Business Name'/>
                {errors.businessname && (
            ...
            <div className='flex flex-col'>
                ...
                <div className="flex justify-center items-center p-5">
                  {
                    ...
                    <button onClick={() => certificateRef.current.click()} type='button' className="px-5 py-2 bg-[#27A9E1] font-bold text-sm text-white">Upload File</button>
                        
                  }
                  <input ref={certificateRef} type='file' accept='application/pdf' onChange={(e) => setValue('certificate',e.target.files )} className='hidden border-2 w-full p-2' placeholder='Email Address'/>
                </div>
                {errors.certificate && (
                  <span className="text-sm text-red-500">
              ...
              <button type='submit' className="py-5 bg-[#27A9E1] font-bold text-sm text-white">REGISTER NOW!</button>
            </form>
