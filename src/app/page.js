    ...
    return (
        <div className="Review_cart w-screen sm:w-[320px] text-center px-8 select-text">
            ...
            <Rating
                ...
                value={review.rating}
            />
            <p className="date_review mt-3">{moment(review.created_date).format("ll")}</p>
            <center>
                ...
                <div className="main_home max-w-[650px] mx-auto">
                    ...
                    <div className="mt-8  sm:hidden min-h-9 items-center rounded-3xl w-full">
                        ...
                        <div className="flex items-center justify-between mt-4 gap-3">
                            <div
                                className="w-1/2 s flex shadow-md items-center gap-2 p-3 rounded-full bg-white  font-bold text-[#888888]   text-sm sm:text-base">
                                <LocationIcon/>
                                <input
                                    type="text"
                    ...
                    <div className="mt-8 flex gap-3 items-center flex-col sm:flex-row sm:pb-0 pb-80">
                        ...
                        <div className="flex flex-wrap gap-2 sm:gap-8">
                            <button
                                className="text-[12px] sm:text-base py-2 sm:py-4 px-4 sm:px-6 bg-transparent border border-text rounded-full text-text font-bold">
                                Contractors
                            </button>
                            <button
                                className="text-[12px] sm:text-base py-2 sm:py-4 px-4 sm:px-6 bg-transparent border border-text rounded-full text-text font-bold">
                            ...
                            <div class="rounded-3xl mr-2 mb-2 sm:w-[25%] px-4 py-7  bg-[#B7E2FA]">
                                <div class="h-[180px] sm:h-full flex ">
                                    <div class="relative flex-grow sm:p-3 p-0">
                                        ...
                                        >
                                            Find the
                                            <span className="mx-2 text-[#0067A1]">Top Rated Helperzz</span>
                                            for your project
                                        </h2>
