...
export default function Tabs({id, details}) {
    ...
    const handleButtonClick = () => {
        navigate.push(
            "/write-review/" + details.details.tag + "/" + details.contractor.name.toLowerCase().replaceAll(" ", "-")
        );
    };
    ...
    const ZoomedImageModal = ({imageUrl, onClose, images}) => {
        ...
        return (
            <div
                className="overflow-hidden fixed z-10 top-0 left-0 w-full h-full  bg-black bg-opacity-100 flex justify-center ">
                ...
                <div className="flex flex-col justify-center  sm:mt-[3rem] xl:flex xl:flex-col xl:justify-center">
                    ...
                    <div className="images-cards">
                        <div className="mt-4 relative">
                            ...
                            <div
                                className="absolute top-1/2 transform -translate-y-1/2 left-[14px]  sm:left-0 right-[27px] sm:right-0 flex justify-between">
                                <button
                                        ...
                                        <div className="lg:ml-4">
                                            ...
                                            <div className="flex gap-2 items-center text-text md:text-md text-sm">
                                                ...
                                                <>
                                                    ...
                                                    <span
                                                        className="text-[#444444]">{`(${details.reviews.length} Reviews)`}</span>
                                                </>
                                            ...
                                            <div className="min-h-[300px] flex justify-center items-center">
                                                <div>
                                                    <div className="flex justify-center">
                                                        <DoneIcon
                                                            className="m-auto my-4 border-2 rounded-full p-2 text-[#2B937C] border-[#2B937C]"
                                                            style={{fontSize: 60}}/>
                                                    </div>
                                                    <h1 className="text-center font-[500] text-gray-600">Thank you, your
                                                        request has been sent. We're getting to work now to match you
                                                        with most suitable contractors for your job</h1>
                                                </div>
                                            </div>
                                        ...
                                        {details?.subcategories?.map((item, index) => (
                                            <button
                                                ...
                                                onClick={() => {
                                                    ...
                                                    setSelectedProjectValue(item?.subcategory)
                                                }}
      ...
      />
                                    ...
                                    <div className="flex max-md:flex-col ml-4  md:pl-0 gap-2 items-center mt-10 ">
                                        <div className="flex items-center gap-4  max-md:mr-auto">
                                            ...
                                            <LuArrowUpDown onClick={() => toggleReviews()}
                                                           className={`md:h-6 md:w-6  h-4 w-4 cursor-pointer ${showLatest === 'Oldest' ? 'text-gray-400' : 'text-gray-900'}`}
                                        ...
                                        <div className="flex items-center gap-2 max-md:mr-auto">
                                            ...
                                            <LuArrowUpDown onClick={() => toggleStars()}
                                                           className={`md:h-6 md:w-6  h-4 w-4 cursor-pointer ${!showHighestStars ? 'text-gray-400' : 'text-gray-900'}`}/>
                                        </div>
                                        <div className="flex items-center gap-2 max-md:mr-auto">
                                            <p className="sm:text-2xl font-semibold text-md">
                                                Reviews with Photos
                                            ...
                                            <input
                                                type="checkbox"
                                                className="w-6 h-6 ml-2  " checked={showPic}
                                    ...
                                    <div
                                        className="flex justify-between md:mt-6 mt-2 flex-wrap lg:flex-nowrap gap-3 md:gap-4">
                                        <div
                                            className="flex-col justify-between flex-wrap lg:flex-nowrap gap-3 md:gap-4 w-[75%]">
                                        ...
                                        <div className="flex-col justify-between lg:w-[25%] w-screen lg:pr-0 pr-10">
                                            <div className="flex flex-col bg-white rounded-lg lg:p-8 p-4">
                                                ...
                                                <div className="flex mt-5">
                                                    ...
                                                    <p className="ml-2 text-md">
                                                        <span>{`${givenRating ? givenRating.toFixed(2) : 0} / 5`}</span>{" "}
                                                        <span
                                                            className="text-gray-400">{`(${details?.reviews?.length} Reviews)`}</span>
                                                    </p>
                                                </div>
                                                <button
                                            ...
                                            <div className="mt-8 ">
                                                ...
                                                <div
                                                    className="min-h-80 flex items-center flex-col justify-center bg-white lg:w-full  rounded-lg">
                                                    <iframe
                    ...
                    {isLoaded ? (
                        ...
                        <TabPanel value="3">
                            {gallery?.length > 0 ?
                                ...
                                <div
                                    className="img_align w-[screen] pl-2 md:pl-0  overflow-x-auto  flex flex-wrap gap-10">
                    ...
                    {isLoaded ? (
                        ...
                        <TabPanel value="4">
                            {details?.reviews?.length > 0 ?
                                                ...
                                                <div className="mt-8">
                                                    ...
                                                    <div
                                                        ...
                                                        <center className="lg:w-full w-[screen] mt-6">
                                                            <button
                                                                className="hover:bg-secondary hover:text-white transition-all cursor-pointer bg-transparent  font-semibold py-4 px-6  border sm:text-md  border-[#12937C] rounded-2xl mx-auto mt-2  ">
                                                                VIEW SERVICE AREA{" "}
                                                            </button>
                                                        </center>
                                                    </div>
                                ...
                                :
                                <h1 className="text-center font-[600] text-[2rem] max-md:text-[1.2rem]">No Reviews
                                    Found </h1>}
                        </TabPanel>
                    )}
                </div>
